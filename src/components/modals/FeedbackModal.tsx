      ...
      <DialogContent className="bg-white sm:max-w-[800px] p-0 overflow-hidden">
        <DialogHeader className="p-6 border-b">
          <div className="flex items-center gap-4">
            ...
            <DialogTitle className="text-xl font-semibold text-left">Share your thoughts</DialogTitle>
          </div>
        </DialogHeader>
          ...
          <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="space-y-3 mt-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">A new feature suggestion</p>
                    </div>
                  </div>
            ...
            <div className="md:w-3/5 mt-4 md:mt-0">
              ...
              <textarea
                ...
                className="w-full h-[210px] px-3 py-2 text-sm text-gray-700 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 resize-none shadow-sm transition-colors duration-150 ease-in-out"
              />
              <div className="mt-1 flex justify-between items-center">
                ...
                <span className={`text-xs ${
                  charCount > maxCharCount * 0.9 ? 'text-red-500' : 
                  charCount > maxCharCount * 0.75 ? 'text-orange-500' : 'text-gray-500'
                }`}>
        ...
        <DialogFooter className="p-4 bg-gray-50 border-t sm:justify-between">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-1 transition-colors duration-150 ease-in-out"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium text-white transition-colors duration-150 ease-in-out ${
              isSubmitting || !selectedType || !feedbackContent.trim()
                ...
                : 'bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1'
            }`}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
