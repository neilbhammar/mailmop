        ...
        <div className="p-8 mt-2">
          <div className="space-y-4">
            <Button
              ...
              disabled={isLoading}
              className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition-all duration-200 shadow-sm hover:shadow border border-gray-300 flex items-center justify-center"
            >
              {isLoading ? (
                <>
            ...
            {!isLoading && (
              <Button
                ...
                className="w-full h-12 border-none hover:bg-gray-100 text-gray-700 font-medium rounded-xl transition-all"
              >
                Cancel
              </Button>
            )}
