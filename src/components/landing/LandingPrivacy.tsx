...
export default function LandingPrivacy() {
  ...
  return (
    <section id="privacy" className="py-12 md:py-16 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto rounded-2xl bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 relative overflow-hidden p-10 shadow-2xl">
          ...
          <div className="absolute top-10 right-10 text-white/10 animate-float-slow opacity-50">
          ...
          <div className="absolute bottom-10 left-10 text-white/10 animate-float-delayed-more opacity-50">
