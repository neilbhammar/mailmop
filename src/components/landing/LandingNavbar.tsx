...
export default function LandingNavbar({ signIn, lenis }: LandingNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full py-3 backdrop-blur-md bg-white/80 border-b border-gray-100">
      <nav className="container mx-auto px-4 flex items-center justify-between h-14">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a 
            ...
            className="text-sm text-gray-600 hover:text-blue-600 transition-colors font-medium flex items-center"
          >
        ...
        <button 
          onClick={signIn} 
          className="flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-transparent text-gray-700 hover:bg-gray-50 transition-colors text-sm font-medium shadow-sm border border-gray-100"
        >
