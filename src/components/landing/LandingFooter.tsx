          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-8">
            ...
            <div className="mb-8 md:mb-0 md:max-w-xs">
              <Link href="/" className="inline-flex items-center">
                <Image src="/logo10.png" alt="MailMop" width={140} height={140} className="mr-3" />
              </Link>
              ...
              <div className="mt-4 flex items-center gap-4">
                <a href="https://github.com/neilbhammar/mailmop" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
                ...
                {/* Add Twitter/X link if available, for now, keeping GitHub only */}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mt-4 md:mt-0">
              <div>
                ...
                <ul className="space-y-3">
                  <li><a href="#how-it-works" className="text-gray-500 hover:text-blue-600 text-sm">How it works</a></li>
                  <li><a href="#pricing" className="text-gray-500 hover:text-blue-600 text-sm">Pricing</a></li>
                  <li><a href="#faq" className="text-gray-500 hover:text-blue-600 text-sm">FAQ</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link href="/privacy" className="text-gray-500 hover:text-blue-600 text-sm">Privacy Policy</Link></li>
                  <li><Link href="/terms" className="text-gray-500 hover:text-blue-600 text-sm">Terms of Service</Link></li>
                </ul>
              </div>
