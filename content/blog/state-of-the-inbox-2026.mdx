...
faqs:
  ...
  - question: "Do people delete or unsubscribe more?"
    answer: "People delete far more than they unsubscribe. MailMop users have deleted over 2.3 million emails and processed about 6,000 unsubscribes. Deleting clears the backlog, but unsubscribing is what stops the same newsletters from refilling the inbox next week."
  - question: "Where does this data come from?"
    answer: "From MailMop's own anonymized usage between May 2025 and September 2026. MailMop processes email in your browser and never stores message contents, so these figures come from anonymous action counts (emails analyzed, deleted, marked, unsubscribed) and the estimated size of inboxes analyzed, not from reading anyone's mail."
---

# The State of the Inbox 2026

Most "email statistics" you find online are the same handful of numbers, recycled for a decade with no source. This report is different. Everything below comes from MailMop's own anonymized usage data between May 2025 and September 2026: roughly 560 users, 16.6 million emails analyzed, and 2.3 million deleted. It's a small sample, but it's real, and it shows what cluttered inboxes actually look like once someone finally opens the hood.
...
| Metric | Value |
|---|---|
| Emails analyzed | 16.6 million |
| Emails deleted | 2.3 million |
| Emails marked as read or organized | 2.5 million |
| Unsubscribes processed | ~6,000 |
| Average inbox size | ~30,500 emails |
| Median inbox size | ~12,300 emails |
...
Ask someone how many emails are in their inbox and they'll usually guess a few hundred unread. The real number is closer to **30,500 on average**, with a median around **12,300**.
...
- **Deleting** is the most common action by far: over **2.3 million emails** removed.
- **Marking as read and organizing** runs close behind at **2.5 million**, as people declare inbox bankruptcy on old mail without actually deleting it.
- **Unsubscribing** is the smallest of the three at about **6,000** actions.
