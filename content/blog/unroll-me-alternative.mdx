...
To be fair, none of this means Unroll.Me is malware or a scam — it's a functioning product that a lot of people have used happily for years, and its data is described as deidentified or aggregated. The question is simply whether you're comfortable with a business model where market-research data drawn from your inbox is the product. If you're not, that's the reason to look at an alternative.
...
The thing that makes it a meaningful Unroll.Me alternative is the privacy model:
...
It's worth being honest about this, because the two tools aren't trying to do exactly the same thing.
...
1. **Revoke Unroll.Me's access** in your Google Account, under Security → Third-party apps with account access. (Removing app access is good hygiene any time you stop using a tool.)
