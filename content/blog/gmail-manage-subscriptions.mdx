...
Can't see it at all? Read [Gmail Manage subscriptions not showing: 8 fixes](/blog/gmail-manage-subscriptions-not-showing) for the checklist, including the two ways to unsubscribe from everything without waiting for the rollout.
...
3) **Bulk actions:**
   ...
   - **Mark as Read**, **Add/Remove Label**, **Create Filters** for ongoing control
